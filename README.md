...
At this stage we will now "compose" the proposed scenario.
Take a look at the docker-compose.yml file in the root of this directory and to how it looks and change the following variables if that apply to your case.
